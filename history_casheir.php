...
<header class="">
    ...
    <div class="row">
      ...
      <?php while($row = $result->fetch_assoc()): ?>
        ...
        <div style="background-color:#D8D8D4;height:auto;width:700px;margin-left:25%;padding:20px;margin-top:-5%">
            <?php echo " x". $row['Unit'] ?>
            <?php echo $row['Name'] ?>
            <?php echo $row['Size'] ?>
