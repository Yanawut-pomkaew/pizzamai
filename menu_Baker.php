...
<body>
    ...
    <div class="list">
        <?php while($row = $result->fetch_assoc()): ?>
            ...
            <div class="l" style="text-align:center;">
                    <tr>
                        ...
                        <td class="name">
                         <?php echo "<img src=".$row['Photo']." width='180' height='120'> "?>
                        </td><br>
        ...
        <button type="button" name="logout" class="btn" style="background:#F52D39;border:1px solid black;height:40px;width:100px;margin-left:45%;margin-top:40px" onclick="document.location='logout.php'">Logout</button>
